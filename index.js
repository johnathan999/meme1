...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.D00AcQ.h3YMoo8NtQaZDjJL-v02450dX9U");
...
client.on('message', message => {
  ...
  client.on('ready',() => {
    ...
    let statusArray = [
            ...
            `${settings.botPREFIX}help | Le bot et en développement<=`
...
client.on('ready', () => {
  // Module Configuration Constructor
   antispam(client, {
        ...
        warningMessage: "Arrêtez de spam !", // Message users receive when warned. (message starts with '@User, ' so you only need to input continue of it.) 
        banMessage: "A été frappé par un marteau d'interdiction pour avoir spam!", // Message sent in chat when user is banned. (message starts with '@User, ' so you only need to input continue of it.) 
        ...
        exemptUsers: ["♛Jean0™㋡ 💎#1070"] // The Discord tags of the users (e.g: MrAugu#9016) (case sensitive) that are exempt from spam filter.
      });
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "help"){
        ...
        .addField(":no_entry:ub!!antispam.help", "Affiche l'aide pour l'auto antispma du bot")
    ...
    if(message.content === prefix + "antispam.help"){
      var help_embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setTitle("Voici l'aide pour la commande :no_entry:antispam.help")
      .setThumbnail(message.author.avatarURL)
      .addField("L'auto antispam du bot", "Donnez le bot la perm ban et kick, et avez plus peur que quelq'un spam parce que quand la personne spam il recois un avertissement du bot si il continue le bot le bannera tout de suite")
      .addField("L'auto antispam du bot", "L'antispam reste on pour votre sécurité donc fini les gens qui spam parce que vous etes protéger par le bot")
      .setFooter("Anti spam Ultra Bot corporation")
      .setTimestamp()
      message.channel.sendMessage(help_embed);
      console.log("Des raideurs ont ete ban par le bot")
    }
...
if(message.content.startsWith(prefix + "ui")) {
  const member = message.mentions.members.first() || message.member;
    ...
    .addField(`${member.user.username}'s Info`, `Voici les info que j'ai trouvée pour ${member.user.username} !`)
