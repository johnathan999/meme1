...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.Dz_Wlg.EWxiZCJrUW2mq6EicQaWpFOFntU");
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "help"){
        ...
        .addField(":heavy_plus_sign:addrole.help", "Affiche l'aide pour le addrole d'Ultra Bot")
        .addField(":heavy_minus_sign:removerole.help", "Affiche l'aide pour le removerole d'Ultra Bot")
    ...
    if(message.content === prefix + "addrole.help"){
      var help_embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setTitle("Voici l'aide pour la commande :heavy_plus_sign:addrole.help")
      .setThumbnail(message.author.avatarURL)
      .addField("ub!!addrole [@lerole] [@l'utilisateur]")
    ...
    if(message.content === prefix + "removerole"){
      ...
      .setThumbnail(message.author.avatarURL)
      .addField("ub!!remove [@lerole] [@l'utilisateur]")
    ...
    if(message.content === prefix + "upgrades"){
      var help_embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setTitle("Voici les mise a jours de mes commandes")
      .setThumbnail(message.author.avatarURL)
      .addField("Nouveaux commandes", "addrole","removerole",)
      .setFooter()
      message.channel.sendMessage(help_embed);
      console.log("quelq'un a fait la commande de mise a jours")
    }
