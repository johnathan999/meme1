...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.Dthnqg.7C-JHp7d7zRIHkNvW7vWZT1BiPM");
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "utilitaires.help"){
      ...
      .addField("ub!!annonce", "vous voulez faire une annonce urgente faite ce commande(ub!!annoce + votre annonce)")
