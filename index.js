...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.D042fg.phriO3F4eY_lOgnaspD7zSKXQ1o");
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "update"){
      ...
      .addField("pf", "Vous permez de jouer a pf avec le bot")
      .addField("calin", "Le bot te fais un gros calin")
      .addField("ub!!help.ticket", "Affiche l'aide pour le systeme de ticket du bot")
...
if(message.content.startsWith(prefix + "ticket")) {
  ...
  if (!message.guild.roles.exists("name", "Help Team")) return message.channel.send(":x: Je peut pas trouver le tole `Help Team` il est introuvable. Merci de contacter un administrateur du serveur pour résoudre cette erreur !");
