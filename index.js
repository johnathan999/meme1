...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.D0pHOw.QHQeJ_BQmUrv1HUSd2RJ8lvrJwQ");
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "help"){
        ...
        .addField(":notepad_spiral:ub!!help.stats", "Affiche l'aide pour la commande stats")
    ...
    if(message.content === prefix + "help.stats"){
      var help_embed = new Discord.RichEmbed()
      .setColor("Random")
      .setTitle("Voici l'aide pour la commande :notepad_spiral:stats.help")
      .setThumbnail(message.author.avatarURL)
      .addField("ub!!stats", "Le bot donne des infos sur votre profil")
      .addField("ub!!stats[@utilisateur]", "Le bot donne des infos sur le profil d'utilisateur mentionner")
      .setFooter("Ultra Bot stats corporation")
      .setTimestamp()
      message.channel.sendMessage(help_embed);
      console.log("quelq'un a utilier la commande de stats")
    }
    ...
    if(message.content === prefix + "update"){
      ...
      .addField("stats", "Vous permez de voir les infos sur votre profil ou celle du membre mentionner")
  ...
  if(message.content.startsWith(prefix + "slots")) {
    ...
    if(message.content.startsWith(prefix + "stats")) {
      ...
      message.channel.send({
          embed: {
              color: 0xe7d4eb,
              title: `Statistiques sur l'utilisateur **${membre.user.username}**`,
              thumbnail: {
              ...
              fields: [
                  ...
                  {
                      name: "Vous avez rejoin le :",
                      value: moment.utc(membre.joinedAt).format("LL")
                  }
              ],
              footer: {
                  text: `Informations sur l'utilisateur ${membre.user.username}`
              }
          }
      })
...
if(!message.guild.member(message.author).hasPermission("MANAGE_GUILD")) return message.reply("**:x: Vous n'avez pas la permission `Gérer le serveur` dans ce serveur dsl je peut pas executer votre commande**").catch(console.error);
  ...
  var args = message.content.substring(prefix.length).split(" ");
    ...
    .setColor("RANDOM")
    .setTitle("statitiques")
    .addField("stats de l'utilisateur")
    .addField("stats de l'utilisateur")
    .setTimestamp()
    .setThumbnail(message.author.avatarURL)
    message.reply()
