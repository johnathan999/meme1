...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.Dzpo3A.IWruNcZ1LonxeJTmRXIGIazsde0");
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "si"){ 
        ...
        .addField("Activité des membres", message.guild.members.filter(utilisateurs => utilisateurs.presence.status === "dnd / idle / offline / online").size)
